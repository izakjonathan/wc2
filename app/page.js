...
export default function Home() {
  ...
  const [fullRepositoryReplace, setFullRepositoryReplace] = useState(false);
  ...
  async function commitZip() {
    ...
    try {
      ...
      form.append("fullRepositoryReplace", fullRepositoryReplace ? "true" : "false");
    ...
    <main>
      ...
      <section className="card">
        ...
        <div className="toggle" style={{ marginTop: 14 }}>
          <input id="fullRepositoryReplace" type="checkbox" checked={fullRepositoryReplace} onChange={(e) => setFullRepositoryReplace(e.target.checked)} />
          <label htmlFor="fullRepositoryReplace" style={{ margin: 0 }}>
            Full Repository Replace
            <br />
            <small>Deletes every tracked file before uploading the ZIP.</small>
          </label>
        </div>
        {fullRepositoryReplace && <div style={{ marginTop: 14 }}>
          <label>Type REPLACE to confirm</label>
          <input value={replaceConfirm} onChange={(e) => setReplaceConfirm(e.target.value)} placeholder="REPLACE" />
        </div>}
      ...
      <section className="card">
        ...
        <div className="actions">
          <button disabled={busy || !zipFile || (fullRepositoryReplace && replaceConfirm !== "REPLACE")} onClick={commitZip}>
